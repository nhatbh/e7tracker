...
import { Hero, HeroClass, HeroElement } from "../../app/models/hero";
import { AftermathSkill, DoT, HitType, Skill } from "../../app/models/skill";
...
export const Heroes: Record<string, Hero> = {
  ...
  abigail: new Hero({
    ...
    skills: {
      s1: new Skill({
        ...
        rate: () => 0.8,
        pow: () => 0.9,
        flat: (_soulburn: boolean, inputValues: DamageFormData, artifact: Artifact) => inputValues.casterFinalMaxHP(artifact) * 0.12,
      ...
      s3: new Skill({
        ...
        rate: () => 1.2,
        pow: () => 0.95,
        flat: (_soulburn: boolean, inputValues: DamageFormData, artifact: Artifact) => inputValues.casterFinalMaxHP(artifact) * 0.2,
  ...
  adventurer_ras: new Hero({
    ...
    skills: {
      s1: new Skill({
        ...
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => 1 + (inputValues.skillTreeCompleted ? 0.1 : 0),
  ...
  ae_giselle: new Hero({
    ...
    skills: {
      s1: new Skill({
        id: 's1',
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => 1 + inputValues.targetCurrentHPPercent * 0.002,
  ...
  ae_karina: new Hero({
    ...
    baseDefense: 648,
    baseHP: 6751,
    heroSpecific: ['casterDefense', 'targetDefenseDownAftermath'],
    skills: {
      s1: new Skill({
        id: 's1',
        defenseScaling: true,
        rate: () => 0.5,
        pow: () => 1,
        flat: (soulburn: boolean, inputValues: DamageFormData, artifact: Artifact) =>  inputValues.casterFinalDefense(artifact) * 1.0,
      ...
      s3: new Skill({
        ...
        rate: () => 0.5,
        pow: () => 1,
        flat: (soulburn: boolean, inputValues: DamageFormData, artifact: Artifact) => inputValues.casterFinalDefense(artifact) * 0.5,
  ...
  afternoon_soak_flan: new Hero({
    ...
    skills: {
      ...
      s1_bis: new Skill({
        name: 'afternoonSoakFlanItsAWhopper',
        id: 's1_bis',
        enhanceFrom: 's1',
        rate: () => 0.7,
        pow: () => 1,
  ...
  aki: new Hero({
    ...
    innateAttackIncrease: (inputValues: DamageFormData) => {
      ...
      for (let i = 0; i < inputValues.molagoras2; i++) {
        boost += Heroes.aki.skills.s2.enhance[i];
      }
      return boost;
    },
    skills: {
  ...
  alexa: new Hero({
    ...
    skills: {
      ...
      s3: new Skill({
        ...
        rate: () => 1.5,
        pow: () => 0.9,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => 1 + inputValues.targetNumberOfDebuffs * 0.15,
  ...
  all_rounder_wanda: new Hero({
    ...
    skills: {
      s1: new Skill({
        ...
        rate: () => 0.9,
        pow: () => 0.95,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => inputValues.targetTargeted ? 1.35 : 1,
  ...
  angelica: new Hero({
    ...
    barrier: (hero: Hero, skill: Skill, artifact: Artifact, inputValues: DamageFormData, _attackMultiplier: number, _soulburn: boolean) => inputValues.casterFinalMaxHP(artifact) * 0.15,
    skills: {
      s1: new Skill({
        id: 's1',
        rate: () => 1,
  ...
  apocalypse_ravi: new Hero({
    ...
    baseHP: 7054,
    baseDefense: 652,
    heroSpecific: ['casterMaxHP', 'casterHasWarGod'],
    skills: {
      s1: new Skill({
        id: 's1',
        hpScaling: true,
      ...
      s3: new Skill({
        ...
        penetrate: (soulburn: boolean, inputValues: DamageFormData) => inputValues.casterHasWarGod ? 0.5 : 0,
        isSingle: () => true,
      })
    }
  }),
  ...
  aramintha: new Hero({
    ...
    heroSpecific: ['targetBurnDetonate'],
    dot: [DoT.burn],
    barrier: (hero: Hero, skill: Skill, artifact: Artifact, inputValues: DamageFormData, attackMultiplier: number, soulburn: boolean) => hero.getAttack(artifact, inputValues, attackMultiplier, skill, soulburn, HitType.normal) * 1.2,
    skills: {
      s1: new Skill({
        id: 's1',
        rate: () => 1,
  ...
  archdemon_shadow: new Hero({
    ...
    baseHP: 4777,
    baseDefense: 715,
    heroSpecific: ['targetDefenseDownAftermath'],
    dot: [DoT.burn],
    skills: {
      s1: new Skill({
        id: 's1',
      ...
      s2: new Skill({
        ...
        rate: () => 0.45,
        pow: () => 1.3,
        afterMath: (hitType: HitType) => (hitType !== HitType.miss) ? new AftermathSkill({ attackPercent: 0.4 }) : null,
        isAOE: () => true,
        isExtra: true
      }),
      s3: new Skill({
  ...
  aria: new Hero({
    ...
    barrier: (hero: Hero, skill: Skill, artifact: Artifact, inputValues: DamageFormData, _attackMultiplier: number, _soulburn: boolean) => inputValues.casterFinalDefense(artifact) * 1.0,
    skills: {
      s1: new Skill({
        id: 's1',
        defenseScaling: true,
        rate: () => 0.7,
        pow: () => 1,
        flat: (soulburn: boolean, inputValues: DamageFormData, artifact: Artifact) => inputValues.casterFinalDefense(artifact) * 0.85,
      ...
      s2: new Skill({
        ...
        rate: () => 0.7,
        pow: () => 1.3,
        flat: (soulburn: boolean, inputValues: DamageFormData, artifact: Artifact) => inputValues.casterFinalDefense(artifact) * 1.4,
  ...
  armin: new Hero({
    ...
    baseHP: 6189,
    heroSpecific: ['casterDefense'],
    barrier: (hero: Hero, skill: Skill, artifact: Artifact, inputValues: DamageFormData, _attackMultiplier: number, _soulburn: boolean) => inputValues.casterFinalDefense(artifact) * 0.7,
    skills: {
      s1: new Skill({
        id: 's1',
        defenseScaling: true,
        rate: () => 0.8,
        pow: () => 0.9,
        flat: (soulburn: boolean, inputValues: DamageFormData, artifact: Artifact) => inputValues.casterFinalDefense(artifact) * 0.6,
  ...
  arunka: new Hero({
    ...
    skills: {
      ...
      s3: new Skill({
        ...
        pow: () => 1,
        penetrate: () => 0.7,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => inputValues.targetHasBarrier ? 3.4 : 1,
  ...
  assassin_cidd: new Hero({
    ...
    skills: {
      ...
      s3: new Skill({
        ...
        pow: () => 0.95,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => 1 + inputValues.casterFinalSpeed() * 0.001 + inputValues.targetFinalSpeed() * 0.003,
  ...
  astromancer_elena: new Hero({
    ...
    skills: {
      s1: new Skill({
        ...
        rate: () => 1,
        pow: () => 0.9,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => inputValues.targetHasDebuff ? 1.2 : 1,
  ...
  beehoo: new Hero({
    element: HeroElement.fire,
    class: HeroClass.ranger,
    heroSpecific: ['targetBurnDetonate', 'exclusiveEquipment1'],
    baseAttack: 1191,
    baseHP: 6002,
    baseDefense: 611,
    innateAttackIncrease: (inputValues: DamageFormData) => {
      ...
      return boost + (inputValues.exclusiveEquipment1 ? 0.05 : 0);
    },
    dot: [DoT.burn],
    skills: {
      s1: new Skill({
  ...
  bellona: new Hero({
    ...
    skills: {
      s1: new Skill({
        ...
        rate: () => 1,
        pow: () => 0.95,
        flat: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => inputValues.targetFinalMaxHP() * 0.04,
  ...
  benevolent_romann: new Hero({
    ...
    skills: {
      ...
      s1_bis: new Skill({
        id: 's1_bis',
        name: 'benevolent_romann_mana_burst',
        rate: () => 0.5,
        pow: () => 1,
        isAOE: () => true,
        isExtra: true
  ...
  benimaru: new Hero({
    ...
    skills: {
      s1: new Skill({
        ...
        rate: (soulburn: boolean) => soulburn ? 1.7 : 1,
        pow: () => 1,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => 1 + (inputValues.casterHasMultilayerBarrier ? 0.3 : 0),
        enhance: [0.05, 0.05, 0.05, 0.05, 0.1],
        isSingle: () => true,
      }),
      s2: new Skill({
  ...
  bernard: new Hero({
    ...
    barrier: (hero: Hero, skill: Skill, artifact: Artifact, inputValues: DamageFormData, _attackMultiplier: number, _soulburn: boolean) => inputValues.casterFinalMaxHP(artifact) * 0.2,
    barrierEnhance: 's2',
    barrier2: (hero: Hero, skill: Skill, artifact: Artifact, inputValues: DamageFormData, _attackMultiplier: number) => inputValues.casterFinalMaxHP(artifact) * 0.15,
  ...
  blood_moon_haste: new Hero({
    ...
    barrier: (hero: Hero, skill: Skill, artifact: Artifact, inputValues: DamageFormData, _attackMultiplier: number, _soulburn: boolean) => inputValues.casterFinalMaxHP(artifact) * 0.3,
    barrierEnhance: 's2',
    skills: {
      s1: new Skill({
        id: 's1',
      ...
      s1_bis: new Skill({
        id: 's1_bis',
        name: 'bloodMoonHasteBloodyRetribution',
        rate: () => 0.3,
        pow: () => 1,
        penetrate: () => 1,
        flat: (soulburn: boolean, inputValues: DamageFormData, artifact: Artifact) => inputValues.casterFinalMaxHP(artifact) * 0.1,
      ...
      s3: new Skill({
        ...
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => inputValues.casterHasBloodAura ? 2 : 1,
  ...
  boss_arunka: new Hero({
    ...
    baseHP: 6593,
    heroSpecific: ['casterDefense'],
    barrier: (hero: Hero, skill: Skill, artifact: Artifact, inputValues: DamageFormData, _attackMultiplier: number, _soulburn: boolean) => inputValues.casterFinalDefense(artifact) * 1.2,
    skills: {
      s1: new Skill({
        id: 's1',
        defenseScaling: true,
      ...
      s3: new Skill({
        ...
        rate: () => 0.6,
        pow: () => 0.95,
        flat: (soulburn: boolean, inputValues: DamageFormData, artifact: Artifact) => inputValues.casterFinalDefense(artifact) * 2,
  ...
  brieg: new Hero({
    ...
    barrier2: (hero: Hero, skill: Skill, artifact: Artifact, inputValues: DamageFormData, _attackMultiplier: number) => {
      let boost = 1.0;
      for (let i = 0; i < inputValues.molagoras2; i++) {
        boost += Heroes['brieg'].skills.s2.enhance[i];
      }
  ...
  butcher_corps_inquisitor: new Hero({
    ...
    skills: {
      ...
      s3: new Skill({
        ...
        pow: () => 0.85,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => 1 + (100 - inputValues.casterCurrentHPPercent) * 0.005,
  ...
  bystander_hwayoung: new Hero({
    ...
    skills: {
      ...
      s3: new Skill({
        ...
        pow: () => 0.95,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => inputValues.elementalAdvantage ? (soulburn ? 2.2 : 2) : 1,
  ...
  camilla: new Hero({
    ...
    skills: {
      ...
      s3: new Skill({
        ...
        pow: () => 0.9,
        enhance: [0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.1],
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => 1 + (100 - inputValues.targetCurrentHPPercent) * 0.01,
  ...
  carrot: new Hero({
    ...
    heroSpecific: ['targetBurnDetonate'],
    dot: [DoT.burn],
    barrier: (hero: Hero, skill: Skill, artifact: Artifact, inputValues: DamageFormData, attackMultiplier: number, soulburn: boolean) => hero.getAttack(artifact, inputValues, attackMultiplier, skill, soulburn, HitType.normal) * 0.6,
    barrierEnhance: 's2',
    skills: {
      s1: new Skill({
        id: 's1',
  ...
  celine: new Hero({
    ...
    baseHP: 6267,
    baseDefense: 473,
    barrier: (hero: Hero, skill: Skill, artifact: Artifact, inputValues: DamageFormData, attackMultiplier: number, soulburn: boolean) => hero.getAttack(artifact, inputValues, attackMultiplier, skill, soulburn, HitType.normal) * 0.5,
    skills: {
      s1: new Skill({
        id: 's1',
        rate: () => 1.2,
  ...
  chaos_inquisitor: new Hero({
    ...
    skills: {
      s1: new Skill({
        ...
        rate: () => 1,
        pow: () => 1,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => 1 + (inputValues.skillTreeCompleted ? 0.05 : 0),
      ...
      s3: new Skill({
        ...
        rate: (soulburn: boolean) => soulburn ? 2.2 : 1.5,
        pow: () => 0.85,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => 1 + (1 - (inputValues.casterCurrentHPPercent / 100)) / 2 + (inputValues.skillTreeCompleted ? 0.12 : 0),
  ...
  charlotte: new Hero({
    ...
    baseHP: 5825,
    baseDefense: 662,
    heroSpecific: ['exclusiveEquipment1', 'casterBuffed', 'targetIsHighestDefense'],
    barrier: (hero: Hero, skill: Skill, artifact: Artifact, inputValues: DamageFormData, attackMultiplier: number, soulburn: boolean) => {
      const scale = [0.05, 0.1, 0.1, 0.1, 0.15];
      let boost = 1.0;
      for (let i = 0; i < inputValues.molagoras1; i++) {
        boost += scale[i];
      }
      return hero.getAttack(artifact, inputValues, attackMultiplier, skill, soulburn, HitType.normal) * 0.5 * boost;
    },
    skills: {
      s1: new Skill({
        id: 's1',
        ...
        exclusiveEquipmentMultiplier: (inputValues: DamageFormData) => inputValues.exclusiveEquipment1 ? 0.1 : 0,
        isAOE: () => true,
        mult: (soulburn: boolean, inputValues: DamageFormData) => inputValues.casterBuffed ? 1.5 : 1,
        multTip: () => ({ casterBuffed: 0.5 }),
      }),
      s3: new Skill({
        id: 's3',
        onlyCrit: () => true,
        ...
        mult: (soulburn: boolean, inputValues: DamageFormData) => inputValues.casterBuffed ? 1.5 : 1,
        multTip: () => ({ casterBuffed: 0.5 }),
        penetrate: (soulburn: boolean, inputValues: DamageFormData) => inputValues.targetIsHighestDefense ? 1 : 0,
      })
    }
  }),
  charlotte_old: new Hero({
    element: HeroElement.fire,
    class: HeroClass.knight,
    baseAttack: 1134,
    baseHP: 5825,
  ...
  chloe: new Hero({
    ...
    skills: {
      s1: new Skill({
        ...
        rate: () => 1,
        pow: () => 0.9,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => inputValues.targetMagicNailed ? 1.3 : 1,
  ...
  cidd: new Hero({
    ...
    skills: {
      ...
      s3: new Skill({
        ...
        pow: () => 1,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => 1 + inputValues.casterFinalSpeed() * 0.0021,
  ...
  clarissa: new Hero({
    ...
    skills: {
      ...
      s3: new Skill({
        ...
        pow: () => 1,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => inputValues.casterEnraged ? 1.2 : 1,
  ...
  closer_charles: new Hero({
    ...
    skills: {
      ...
      s1_alt: new Skill({
        ...
        rate: () => 1.4,
        pow: () => 1,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => 1 + (100 - inputValues.targetCurrentHPPercent) * 0.004,
  ...
  commander_lorina: new Hero({
    ...
    baseHP: 4895,
    baseDefense: 543,
    heroSpecific: ['targetMaxHP', 'attackSkillStack', 'skillTreeCompleted', 'effectResistance'],
    ...
    skills: {
      s1: new Skill({
        ...
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => inputValues.skillTreeCompleted ? 1.2 : 1,
        multTip: (inputValues: DamageFormData) => (inputValues.skillTreeCompleted ? { skill_tree: 20 } : null),
        enhance: [0.05, 0.05, 0.1, 0.1, 0.1],
        isSingle: () => true,
      }),
      s2: new Skill({
      ...
      s3: new Skill({
        ...
        rate: () => 1.5,
        pow: () => 0.95,
        flat: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => inputValues.targetFinalMaxHP() * 0.03,
        flatTip: () => ({ targetMaxHP: 3 }),
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => inputValues.skillTreeCompleted ? 1.2 : 1,
        multTip: (inputValues: DamageFormData) => (inputValues.skillTreeCompleted ? { skill_tree: 20 } : null),
        penetrate: (soulburn: boolean, inputValues: DamageFormData) => inputValues.effectResistance >= 200 ? 0.5 : 0,
        enhance: [0.05, 0.05, 0, 0.1, 0.15],
        isSingle: () => true,
      })
    }
  ...
  commander_pavel: new Hero({
    ...
    skills: {
      ...
      s3: new Skill({
        id: 's3',
        soulburn: true,
        rate: (soulburn: boolean) => soulburn ? 1.2 : 0.85,
        pow: () => 1,
  ...
  corvus: new Hero({
    ...
    skills: {
      s1: new Skill({
        ...
        pow: () => 1,
        flat: (soulburn: boolean, inputValues: DamageFormData, artifact: Artifact) => (inputValues.casterEnraged ? 1.2 : 0.9) * inputValues.casterFinalDefense(artifact),
  ...
  death_dealer_ray: new Hero({
    ...
    skills: {
      s1: new Skill({
        ...
        rate: () => 1,
        pow: () => 1,
        fixed: (hitType: HitType, inputValues: DamageFormData) => hitType !== HitType.miss ? (inputValues.targetInjuries * 0.4) : 0,
        enhance: [0.05, 0.05, 0, 0.1, 0.1],
        single: true,
      })
    }
  ...
  designer_lilibet: new Hero({
    ...
    skills: {
      ...
      s3: new Skill({
        ...
        rate: () => 0.6,
        pow: () => 1,
        flat: (soulburn: boolean, inputValues: DamageFormData, artifact: Artifact) => inputValues.casterFinalDefense(artifact) * 1,
        flatTip: () => ({ casterDefense: 100 }),
        penetrate: () => 0.5,
        enhance: [0.05, 0.05, 0, 0.05, 0.15],
        isAOE: () => true,
  ...
  disciplinary_prefect_aria: new Hero({
    ...
    skills: {
      ...
      s1_bis: new Skill({
        id: 's1_bis',
        name: 'disciplinaryPrefectAriaDisciplinaryAction',
        hpScaling: true,
        rate: () => 0.75,
        pow: () => 1,
  ...
  dizzy: new Hero({
    ...
    skills: {
      s1: new Skill({
        ...
        rate: () => 0.7,
        pow: () => 1,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => inputValues.targetHasDebuff ? 1.3 : 1.0,
  ...
  dominiel: new Hero({
    ...
    baseHP: 5016,
    baseDefense: 645,
    barrier: (hero: Hero, skill: Skill, artifact: Artifact, inputValues: DamageFormData, attackMultiplier: number, soulburn: boolean) => hero.getAttack(artifact, inputValues, attackMultiplier, skill, soulburn, HitType.normal),
    skills: {
      s1: new Skill({
        id: 's1',
        rate: () => 1,
  ...
  dragon_bride_senya: new Hero({
    ...
    skills: {
      ...
      s3: new Skill({
        ...
        pow: () => 0.9,
        flat: (soulburn: boolean, inputValues: DamageFormData, artifact: Artifact) => inputValues.casterFinalMaxHP(artifact) * 0.11,
        flatTip: (_soulburn: boolean) => ({ casterMaxHP: 11 }),
  ...
  eaton: new Hero({
    ...
    baseDefense: 703,
    heroSpecific: ['casterMaxHP'],
    barrier: (hero: Hero, skill: Skill, artifact: Artifact, inputValues: DamageFormData, _attackMultiplier: number, _soulburn: boolean) => inputValues.casterFinalMaxHP(artifact) * 0.25,
    barrierEnhance: 's3',
    skills: {
      s1: new Skill({
        id: 's1',
  ...
  edward_elric: new Hero({
    ...
    skills: {
      ...
      s3: new Skill({
        ...
        flat: (soulburn: boolean, inputValues: DamageFormData, artifact: Artifact) => inputValues.casterFinalMaxHP(artifact) * 0.25,
        flatTip: () => ({casterMaxHP: 25}),
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => 1 + inputValues.attackSkillStack * 0.2,
  ...
  eligos: new Hero({
    ...
    skills: {
      ...
      s2: new Skill({
        ...
        rate: () => 1.4,
        pow: () => 1.3,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => 1 + inputValues.casterFinalSpeed() * 0.0015,
  ...
  elphelt_valentine: new Hero({
    ...
    skills: {
      ...
      s2: new Skill({
        ...
        rate: () => 1,
        pow: () => 1,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => 1 + (inputValues.targetNumberOfDebuffs * 0.2),
  ...
  empyrean_ilynav: new Hero({
    ...
    skills: {
      s1: new Skill({
        ...
        fixed: (hitType: HitType, inputValues: DamageFormData, artifact: Artifact, soulburn: boolean) => inputValues.targetInjuries * (soulburn ? 0.5 : 0),
        enhance: [0.05, 0.05, 0.05, 0.05, 0.1],
        soulburn: true,
        isSingle: () => true,
      }),
  ...
  enott: new Hero({
    ...
    skills: {
      s1: new Skill({
        ...
        rate: () => 1,
        pow: () => 1,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => 1 + (100 - inputValues.targetCurrentHPPercent) * 0.005,
  ...
  ezra: new Hero({
    ...
    skills: {
      s1: new Skill({
        ...
        fixedTip: (_fixedDamage: number, _inputValues: DamageFormData) => ({ per_target_debuff: 1000 }),
        isSingle: () => true,
      }),
      s2: new Skill({
        id: 's2',
        ...
        fixedTip: (_fixedDamage: number, _inputValues: DamageFormData) => ({ per_target_debuff: 1500 }),
        isAOE: () => true,
      })
    }
  }),
  ...
  fallen_cecilia: new Hero({
    ...
    baseDefense: 694,
    heroSpecific: ['casterMaxHP'],
    barrier: (hero: Hero, skill: Skill, artifact: Artifact, inputValues: DamageFormData, _attackMultiplier: number, _soulburn: boolean) => inputValues.casterFinalMaxHP(artifact) * 0.1,
    barrierEnhance: 's2',
    skills: {
      s1: new Skill({
        id: 's1',
  ...
  fenne: new Hero({
    ...
    baseDefense: 775,
    barrier: (hero: Hero, skill: Skill, artifact: Artifact, inputValues: DamageFormData, attackMultiplier: number, soulburn: boolean) => {
      return hero.getAttack(artifact, inputValues, attackMultiplier, skill, soulburn, HitType.normal) * 2.5;
    },
    attackIncrease: (inputValues: DamageFormData) => {
  ...
  fern: new Hero({
    ...
    speedIncrease: (inputValues: DamageFormData) => 1 + inputValues.casterFocus * 0.15,
    skills: {
      s1: new Skill({
        id: 's1',
        speedScaling: true,
        rate: () => 0.9,
        pow: () => 0.9,
        // TODO: there's definitely a better way to handle the speed calculation here
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => 1 + Heroes['fern'].getSpeed(inputValues) * 0.00075,
        multTip: () => ({ casterSpeed: 0.075 }),
      ...
      s3: new Skill({
        ...
        rate: () => 1.35,
        pow: () => 0.95,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => 1 + Heroes['fern'].getSpeed(inputValues) * 0.0015,
        multTip: () => ({ casterSpeed: 0.15 }),
        penetrate: () => 0.7,
  ...
  festive_eda: new Hero({
    ...
    skills: {
      ...
      s2: new Skill({
        ...
        rate: () => 1,
        pow: () => 1,
        afterMath: (hitType: HitType) => (hitType !== HitType.miss) ? new AftermathSkill({ hpPercent: 0.4 }) : null,
        isExtra: true,
        isAOE: () => true,
      }),
      s3: new Skill({
  ...
  fighter_maya: new Hero({
    ...
    skills: {
      s1: new Skill({
        ...
        rate: () => 0.5,
        pow: () => 1,
        flat: (soulburn: boolean, inputValues: DamageFormData, artifact: Artifact) => inputValues.casterFinalDefense(artifact) * 0.75,
      ...
      s3: new Skill({
        ...
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => inputValues.targetCurrentHPPercent < 30 ? 4 : 1,
  ...
  frieren: new Hero({
    ...
    skills: {
      ...
      s1_bis: new Skill({
        ...
        rate: () => 1,
        pow: () => 1,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => 1 + (1 - (inputValues.targetCurrentHPPercent / 100)) * 0.35,
  ...
  guard_captain_krau: new Hero({
    ...
    skills: {
      s1: new Skill({
        ...
        flat: (soulburn: boolean, inputValues: DamageFormData, artifact: Artifact) =>  inputValues.casterFinalDefense(artifact) * 0.85,
        flatTip: () => ({ casterDefense: 85 }),
        afterMath: (hitType: HitType) => (hitType !== HitType.miss) ? new AftermathSkill({ defensePercent: 0.6 }) : null,
        enhance: [0.05, 0, 0.1, 0, 0.15],
        isSingle: () => true,
      }),
      s2: new Skill({
      ...
      s3: new Skill({
        id: 's3',
        defenseScaling: true,
        rate: (soulburn: boolean) => soulburn ? 0.6 : 0.3,
        pow: () => 1,
        flat: (soulburn: boolean, inputValues: DamageFormData, artifact: Artifact) => inputValues.casterFinalDefense(artifact) * (soulburn ? 1.45 : 0.5),
        flatTip: (soulburn: boolean) => ({ casterDefense: (soulburn ? 145 : 50) }),
        enhance: [0.05, 0.05, 0, 0.1, 0.1],
        soulburn: true,
        penetrate: () => 1,
  ...
  harsetti: new Hero({
    ...
    skills: {
      ...
      s3: new Skill({
        ...
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => inputValues.casterFullFocus ? 2 : 1,
  ...
  hataan: new Hero({
    ...
    skills: {
      ...
      s2: new Skill({
        ...
        rate: () => 1.3,
        pow: () => 0.85,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => 1 + inputValues.casterFinalSpeed() * 0.00125,
  ...
  hasol: new Hero({
    ...
    skills: {
      s1: new Skill({
        ...
        rate: () => 0.7,
        pow: () => 1,
        fixed: (hitType: HitType, inputValues: DamageFormData) => 500 + inputValues.enemyCounterStack * 1500,
        flat: (soulburn: boolean, inputValues: DamageFormData, artifact: Artifact) => inputValues.casterFinalMaxHP(artifact) * 0.05,
        flatTip: () => ({ casterMaxHP: 5 }),
        enhance: [0.05, 0.05, 0.05, 0.05, 0.1],
        isSingle: () => true,
  ...
  helen: new Hero({
    ...
    baseHP: 6403,
    heroSpecific: ['casterDefense'],
    barrier: (hero: Hero, skill: Skill, artifact: Artifact, inputValues: DamageFormData, _attackMultiplier: number, _soulburn: boolean) => inputValues.casterFinalDefense(artifact) * 0.8,
    skills: {
      s1: new Skill({
        id: 's1',
        defenseScaling: true,
        rate: () => 0.7,
        pow: () => 1,
        flat: (soulburn: boolean, inputValues: DamageFormData, artifact: Artifact) => inputValues.casterFinalDefense(artifact) * 0.8,
      ...
      s2: new Skill({
        ...
        rate: () => 1.2,
        pow: () => 1,
        flat: (soulburn: boolean, inputValues: DamageFormData, artifact: Artifact) => inputValues.casterFinalDefense(artifact),
        flatTip: () => ({ casterDefense: 100 }),
  ...
  hwayoung: new Hero({
    ...
    baseHP: 6226,
    baseDefense: 627,
    heroSpecific: ['exclusiveEquipment1', 'exclusiveEquipment3', 'targetAttack', 'targetDefenseDownAftermath'],
    ...
    skills: {
      s1: new Skill({
        ...
        pow: () => 1,
        afterMath: (hitType: HitType, _inputValues: DamageFormData, _soulburn: boolean) => hitType !== HitType.miss ? new AftermathSkill({ attackPercent: 0.35 }) : null,
        exclusiveEquipmentMultiplier: (inputValues: DamageFormData) => inputValues.exclusiveEquipment1 ? 0.2 : 0,
        enhance: [0.05, 0.05, 0.05, 0.05, 0.1],
        isSingle: () => true,
        noCrit: true,
      ...
      s3: new Skill({
        ...
        penetrate: (soulburn: boolean, inputValues: DamageFormData, artifact: Artifact, casterAttack: number) => {
          ...
          const penDiff = (casterAttack - targetAtk) * 0.000213;

          return Math.min(Math.max(0, penDiff), 1);
        },
        penetrateTip: () => ({caster_target_atk_diff: 0.0213}),
        exclusiveEquipmentMultiplier: (inputValues: DamageFormData) => inputValues.exclusiveEquipment3 ? 0.1 : 0,
        enhance: [0.05, 0.05, 0, 0.1, 0.1],
        isSingle: () => true,
        noCrit: true,
  ...
  ilynav: new Hero({
    ...
    skills: {
      ...
      s2: new Skill({
        ...
        fixed: (hitType: HitType, inputValues: DamageFormData) => hitType !== HitType.miss ? (inputValues.targetInjuries * 0.5) : 0,
        enhance: [0.05, 0.05, 0, 0.1, 0.1],
        isSingle: () => true,
      }),
      s3: new Skill({
  ...
  immortal_wukong: new Hero({
    ...
    barrier: (hero: Hero, skill: Skill, artifact: Artifact, inputValues: DamageFormData, attackMultiplier: number, soulburn: boolean) => hero.getAttack(artifact, inputValues, attackMultiplier, skill, soulburn, HitType.normal) * 0.3,
    skills: {
      s1: new Skill({
        id: 's1',
        rate: () => 0.85,
  ...
  inheritor_amiki: new Hero({
    ...
    baseHP: 5738,
    baseDefense: 571,
    heroSpecific: ['casterBelow30PercentHP', 'skillTreeCompleted', 'targetDefenseDownAftermath'],
  ...
  jack_o: new Hero({
    ...
    skills: {
      ...
      s3: new Skill({
        ...
        rate: () => 1,
        pow: () => 1,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => inputValues.targetHasDebuff ? 1.5 : 1,
  ...
  januta: new Hero({
    ...
    skills: {
      s1: new Skill({
        ...
        rate: () => 1,
        pow: () => 1,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => inputValues.casterEnraged ? 1.3 : 1,
  ...
  kawerik: new Hero({
    ...
    skills: {
      ...
      s2: new Skill({
        ...
        rate: () => 1.4,
        pow: () => 1,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => 1 + inputValues.targetFinalSpeed() * 0.003,
  ...
  kayron: new Hero({
    ...
    skills: {
      // TODO: add s1 single target
      s1: new Skill({
        id: 's1',
        soulburn: true,
        rate: (soulburn: boolean) => soulburn ? 1.1 : 0.9,
        pow: () => 1,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => 1 + (100 - inputValues.casterCurrentHPPercent) * 0.002,
      ...
      s3: new Skill({
        ...
        rate: () => 1.7,
        pow: () => 0.9,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => 1 + (100 - inputValues.casterCurrentHPPercent) * 0.004,
  ...
  khawana: new Hero({
    ...
    baseHP: 4653,
    baseDefense: 515,
    heroSpecific: ['targetHasDebuff', 'casterSpeed', 'targetDefenseDownAftermath'],
    dot: [DoT.bleed],
    skills: {
      s1: new Skill({
        id: 's1',
  ...
  kikirat_v2: new Hero({
    ...
    skills: {
      ...
      s3: new Skill({
        ...
        pow: () => 1,
        flat: (soulburn: boolean, inputValues: DamageFormData, artifact: Artifact) => inputValues.casterFinalDefense(artifact) * (soulburn ? 0.6 : 0.5),
  ...
  kise: new Hero({
    ...
    baseHP: 5138,
    baseDefense: 522,
    barrier: (hero: Hero, skill: Skill, artifact: Artifact, inputValues: DamageFormData, attackMultiplier: number, soulburn: boolean) => hero.getAttack(artifact, inputValues, attackMultiplier, skill, soulburn, HitType.normal) * 0.65,
    ...
    skills: {
      s1: new Skill({
        ...
        pow: () => 1,
        enhance: [0.05, 0.05, 0.1, 0.1, 0.1],
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => inputValues.targetHasBuff ? 1.7 : 1,
        multTip: () => ({ target_buff: 70 }),
        isSingle: () => true,
      }),
      s2: new Skill({
        id: 's2',
      ...
      s3: new Skill({
        ...
        rate: () => 1.6,
        pow: () => 1,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => 1 + inputValues.casterCurrentHPPercent * 0.0035,
  ...
  kizuna_ai: new Hero({
    ...
    baseDefense: 743,
    heroSpecific: ['casterMaxHP'],
    barrier: (hero: Hero, skill: Skill, artifact: Artifact, inputValues: DamageFormData, _attackMultiplier: number, _soulburn: boolean) => inputValues.casterFinalMaxHP(artifact) * 0.14,
    barrierEnhance: 's3',
    skills: {
      s1: new Skill({
        id: 's1',
  ...
  krau: new Hero({
    ...
    skills: {
      ...
      s3: new Skill({
        ...
        pow: () => 1,
        soulburn: true,
        flat: (soulburn: boolean, inputValues: DamageFormData, artifact: Artifact) => (soulburn ? 0.26785 : 0.53571) * Math.max(inputValues.casterFinalMaxHP(artifact) - inputValues.casterCurrentHP, 0),
        flatTip: (soulburn: boolean) => ({ caster_lost_hp: soulburn ? 26.785 : 53.571 }),
        penetrate: () => 1.0,
        isSingle: (inputValues: DamageFormData, soulburn: boolean) => !soulburn,
        isAOE: (inputValues: DamageFormData, soulburn: boolean) => soulburn,
      })
  ...
  last_piece_karin: new Hero({
    ...
    skills: {
      s1: new Skill({
        ...
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => 1 + inputValues.casterFinalSpeed() * 0.00075,
        multTip: () => ({ casterSpeed: 0.075 }),
        flat: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => inputValues.casterHasNeoPhantomSword ? inputValues.targetFinalMaxHP() * 0.3 : 0,
  ...
  last_rider_krau: new Hero({
    ...
    skills: {
      ...
      s3: new Skill({
        ...
        flat: (soulburn: boolean, inputValues: DamageFormData, artifact: Artifact) => 0.06 * inputValues.casterFinalMaxHP(artifact),
        flatTip: () => ({ casterMaxHP: 6 }),
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => 1 + (inputValues.attackSkillStack * 0.2) + (inputValues.casterFinalSpeed() * 0.001125),
  ...
  leah: new Hero({
    ...
    skills: {
      ...
      s2: new Skill({
        ...
        rate: () => 1.2,
        pow: () => 0.95,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => 1 + inputValues.casterFinalSpeed() * 0.001,
  ...
  lena: new Hero({
    ...
    skills: {
      ...
      s3: new Skill({
        ...
        rate: (soulburn: boolean) => soulburn ? 1.2 : 1,
        pow: () => 1,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => 1 + (100 - inputValues.targetCurrentHPPercent) * 0.002,
  ...
  lethe: new Hero({
    ...
    skills: {
      ...
      s2: new Skill({
        ...
        pow: () => 1.3,
        exclusiveEquipmentMultiplier: (inputValues: DamageFormData) => inputValues.exclusiveEquipment1 ? 0.1 : 0,
        flat: (soulburn: boolean, inputValues: DamageFormData, artifact: Artifact) => inputValues.casterFinalMaxHP(artifact) * 0.23,
        flatTip: () => ({casterMaxHP: 25}),
        penetrate: () => 1,
        noCrit: true,
        isExtra: true,
  ...
  lilias: new Hero({
    ...
    baseHP: 6751,
    baseDefense: 648,
    heroSpecific: ['casterMaxHP', 'highestAllyAttack', 'targetProvoked'],
    skills: {
      s1: new Skill({
        id: 's1',
        hpScaling: true,
      ...
      s3: new Skill({
        id: 's3',
        rate: (soulburn: boolean, inputValues: DamageFormData) => inputValues.targetProvoked ? 1.8 : 1,
        pow: () => 1,
  ...
  lionheart_cermia: new Hero({
    ...
    skills: {
      s1: new Skill({
        ...
        pow: () => 0.9,
        flat: (soulburn: boolean, inputValues: DamageFormData, artifact: Artifact) => inputValues.casterFinalDefense(artifact) * (soulburn ? 1.6 : 1.0),
      ...
      s3: new Skill({
        ...
        rate: () => 0.5,
        pow: () => 0.9,
        flat: (soulburn: boolean, inputValues: DamageFormData, artifact: Artifact) => inputValues.casterFinalDefense(artifact) * 1.35,
  ...
  little_queen_charlotte: new Hero({
    ...
    skills: {
      ...
      s3: new Skill({
        ...
        rate: () => 1.5,
        pow: () => 1,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => inputValues.elementalAdvantage ? 1.5 : 1,
  ...
  lone_crescent_bellona: new Hero({
    ...
    skills: {
      s1: new Skill({
        id: 's1',
        onlyCrit: () => true,
        rate: (soulburn: boolean) => soulburn ? 1.35 : 1,
        pow: () => 1,
        enhance: [0.05, 0.05, 0.05, 0.05, 0.1],
        isSingle: () => true,
        soulburn: true
  ...
  lone_wolf_peira: new Hero({
    ...
    baseHP: 6149,
    baseDefense: 613,
    heroSpecific: ['turnStack', 'targetDefenseDownAftermath'],
  ...
  ludwig: new Hero({
    ...
    baseHP: 4248,
    baseDefense: 645,
    heroSpecific: ['exclusiveEquipment3', 'casterInvincible'],
    skills: {
      s1: new Skill({
        id: 's1',
        rate: () => 1,
  ...
  luluca: new Hero({
    ...
    barrier: (hero: Hero, skill: Skill, artifact: Artifact, inputValues: DamageFormData, attackMultiplier: number, soulburn: boolean) => hero.getAttack(artifact, inputValues, attackMultiplier, skill, soulburn, HitType.normal) * (1 + inputValues.skill3Stack * 0.2) * 0.375,
    barrierEnhance: 's2',
    ...
    skills: {
      s1: new Skill({
        ...
        rate: () => 1,
        pow: () => 1,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => 1 + (1 - (inputValues.targetCurrentHPPercent / 100)) * 0.2,
        enhance: [0.05, 0.05, 0.05, 0.05, 0.1],
        isSingle: () => true,
      }),
      s2: new Skill({
  ...
  mediator_kawerik: new Hero({
    ...
    skills: {
      ...
      s2: new Skill({
        id: 's2',
        hpScaling: true,
        rate: (soulburn: boolean, inputValues: DamageFormData) => inputValues.exclusiveEquipment1 ? 0.75 : 1.5,
        pow: () => 1,
        flat: (soulburn: boolean, inputValues: DamageFormData, artifact: Artifact) => 0.09 * inputValues.casterFinalMaxHP(artifact),
        flatTip: () => ({ casterMaxHP: 9 }),
        penetrate: (soulburn: boolean, inputValues: DamageFormData) => inputValues.exclusiveEquipment1 ? 1 : 0,
        enhance: [0.05, 0, 0, 0, 0.1, 0.15],
        isSingle: () => true,
      })
    }
  ...
  melissa: new Hero({
    ...
    skills: {
      s1: new Skill({
        ...
        rate: () => 1,
        pow: () => 1.1,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => 1 + (100 - inputValues.casterCurrentHPPercent) * 0.0035,
  ...
  monarch_of_the_sword_iseria: new Hero({
    ...
    baseDefense: 645,
    attackIncrease: (inputValues: DamageFormData) => {
      const buff = BattleConstants.fractureAttack;
  ...
  moon_bunny_dominiel: new Hero({
    ...
    baseDefense: 631,
    heroSpecific: ['casterMaxHP'],
    barrier: (hero: Hero, skill: Skill, artifact: Artifact, inputValues: DamageFormData, _attackMultiplier: number, _soulburn: boolean) => inputValues.casterFinalMaxHP(artifact) * 0.20,
    skills: {
      s1: new Skill({
        id: 's1',
        rate: () => 1,
  ...
  mort: new Hero({
    ...
    skills: {
      ...
      s3: new Skill({
        ...
        flatTip: () => ({ casterMaxHP: 15 }),
        exclusiveEquipmentMultiplier: (inputValues: DamageFormData) => inputValues.exclusiveEquipment3 ? 0.1 : 0,
        penetrate: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact, _heroAttack: number) => inputValues.targetIsHighestMaxHP ? 0.7 : 0,
        enhance: [0.05, 0.05, 0, 0.1, 0.1],
        isAOE: () => true,
      })
    }
  ...
  nemunas: new Hero({
    ...
    skills: {
      ...
      s2: new Skill({
        ...
        rate: (soulburn: boolean) => soulburn ? 1.7 : 1,
        pow: () => 0.8,
        flat: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => inputValues.targetFinalMaxHP() * (soulburn ? 0.085 : 0.05),
  ...
  new_moon_luna: new Hero({
    ...
    skills: {
      ...
      s2_splash: new Skill({
        ...
        rate: () => 0,
        pow: () => 0,
        afterMath: (_hitType: HitType, _inputValues: DamageFormData) => new AftermathSkill({ hpPercent: 0.16 }),
        noCrit: true,
        noMiss: true,
      })
    }
  ...
  notos: new Hero({
    ...
    baseHP: 7332,
    baseDefense: 767,
    heroSpecific: ['casterMaxHP', 'casterHasGodOfBattle'],
    skills: {
      s1: new Skill({
        id: 's1',
        hpScaling: true,
        rate: () => 0.5,
        pow: () => 0.9,
        flat: (soulburn: boolean, inputValues: DamageFormData, artifact: Artifact) => inputValues.casterFinalMaxHP(artifact) * (inputValues.casterHasGodOfBattle ? 0.06 : 0.1),
        flatTip: (soulburn: boolean, inputValues: DamageFormData) => ({ casterMaxHP: inputValues.casterHasGodOfBattle ? 6 : 10 }),
        afterMath: (hitType: HitType, inputValues: DamageFormData) => (hitType !== HitType.miss && inputValues.casterHasGodOfBattle) ? new AftermathSkill({ hpPercent: 0.15 }) : null,
        enhance: [0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.1],
        isSingle: () => true,
      }),
      s2: new Skill({
  ...
  operator_sigret: new Hero({
    ...
    skills: {
      ...
      s2: new Skill({
        ...
        rate: () => 0.33,
        pow: () => 1,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => inputValues.targetHasBarrier ? 3 : 1,
        multTip: () => ({ targetHasBarrier: 200 }),
        penetrate: () => 1,
        enhance: [0.05, 0.05, 0.05, 0.05, 0.1],
        isSingle: () => true,
      }),
  ...
  peacemaker_furious: new Hero({
    ...
    skills: {
      ...
      s3: new Skill({
        ...
        rate: () => 0.5,
        pow: () => 0.9,
        flat: (soulburn: boolean, inputValues: DamageFormData, artifact: Artifact) => inputValues.casterFinalDefense(artifact) * 1.3,
        flatTip: () => ({ casterDefense: 130 }),
        penetrate: (_soulburn: boolean, _inputValues: DamageFormData) => 0.6,
        enhance: [0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.1],
        isAOE: () => true,
      }),
    }
  ...
  pyllis: new Hero({
    ...
    heroSpecificMaximums: {'casterAttackedStack': 3},
    barrier: (hero: Hero, skill: Skill, artifact: Artifact, inputValues: DamageFormData, _attackMultiplier: number, _soulburn: boolean) => inputValues.casterFinalDefense(artifact, Heroes.pyllis.defenseIncrease(inputValues)) * 0.6,
    ...
    skills: {
      s1: new Skill({
        ...
        rate: () => 0.7,
        pow: () => 1,
        flat: (soulburn: boolean, inputValues: DamageFormData, artifact: Artifact) => inputValues.casterFinalDefense(artifact, Heroes.pyllis.defenseIncrease(inputValues)) * 0.5,
      ...
      s3: new Skill({
        ...
        rate: () => 1.3,
        pow: () => 0.95,
        flat: (soulburn: boolean, inputValues: DamageFormData, artifact: Artifact) => inputValues.casterFinalDefense(artifact, Heroes.pyllis.defenseIncrease(inputValues)) * 0.7,
  ...
  ran: new Hero({
    ...
    skills: {
      ...
      s3: new Skill({
        ...
        rate: () => 0.8,
        pow: () => 1,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => 1 + inputValues.casterFinalSpeed() * 0.00075 + inputValues.targetFinalSpeed() * 0.0015,
  ...
  revna: new Hero({
    ...
    skills: {
      s1: new Skill({
        ...
        pow: () => 1,
        rate: () => 1,
        flat: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => inputValues.casterPromotionStack > 0 ? inputValues.targetFinalMaxHP() * 0.025 : 0,
      ...
      s3: new Skill({
        ...
        pow: () => 1,
        rate: (soulburn: boolean) => soulburn ? 1.8 : 1.5,
        flat: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => inputValues.casterPromotionStack > 0 ? inputValues.targetFinalMaxHP() * 0.03 : 0,
        flatTip: () => ({ targetMaxHP: 3 }),
        enhance: [0.05, 0, 0.1, 0, 0.15],
        soulburn: true,
        isSingle: () => true,
  ...
  rinak: new Hero({
    ...
    skills: {
      ...
      s3: new Skill({
        ...
        rate: () => 0.32,
        pow: () => 1,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => 1 + inputValues.casterFinalSpeed() * 0.003,
        multTip: () => ({ casterSpeed: 0.3 }),
        fixed: (hitType: HitType, _inputValues: DamageFormData) => (hitType !== HitType.miss) ? 7000 : 0,
        enhance: [0.05, 0.05, 0, 0.05, 0.15],
        isSingle: () => true,
        penetrate: () => 1,
        noCrit: true
  ...
  roaming_warrior_leo: new Hero({
    ...
    skills: {
      s1: new Skill({
        ...
        rate: () => 1,
        pow: () => 1,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => inputValues.targetHasDebuff ? 1.1 : 1,
  ...
  sage_baal_and_sezan: new Hero({
    ...
    baseHP: 5299,
    baseDefense: 673,
    heroSpecific: ['casterMaxHP', 'targetAsleep'],
    skills: {
      s1: new Skill({
        id: 's1',
        rate: () => 1,
      ...
      s3: new Skill({
        ...
        pow: () => 1,
        penetrate: () => 1.0,
        flat: (soulburn: boolean, inputValues: DamageFormData, artifact: Artifact) => 0.24 * inputValues.casterFinalMaxHP(artifact),
        flatTip: () => ({ caster_max_hp: 25 }),
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => inputValues.targetAsleep ? 1.5 : 1,
        multTip: () => ({ target_asleep: 50 }),
        enhance: [0.05, 0.05, 0, 0.1, 0.1],
        noCrit: true,
        isSingle: () => true,
      })
  ...
  savior_adin: new Hero({
    ...
    skills: {
      ...
      s3: new Skill({
        id: 's3',
        soulburn: true,
        rate: (soulburn: boolean) => soulburn ? 1.65 : 1.2,
        pow: () => 1,
        enhance: [0.05, 0.05, 0, 0.1, 0.1],
        penetrate: () => 0.5,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => inputValues.skillTreeCompleted ? 1.2 : 1,
  ...
  schuri: new Hero({
    ...
    baseHP: 5650,
    baseDefense: 536,
    heroSpecific: ['targetMaxHP', 'casterFullFocus'],
    skills: {
      s1: new Skill({
        id: 's1',
        rate: () => 1,
        pow: () => 1,
        flat: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => inputValues.targetFinalMaxHP() * 0.015,
        flatTip: () => ({ targetMaxHP: 1.5 }),
        enhance: [0.05, 0.05, 0, 0.1, 0.1],
        isSingle: () => true,
      }),
      s3: new Skill({
        id: 's3',
        rate: (soulburn: boolean, inputValues: DamageFormData) => inputValues.casterFullFocus ? 1.25 : 1,
        pow: () => 1,
        enhance: [0.05, 0.05, 0, 0.1, 0.1],
        isAOE: () => true,
      })
  ...
  senya: new Hero({
    ...
    heroSpecific: ['targetDefenseDownAftermath'],
    innateAttackIncrease: () => 0.3,
    barrier: (hero: Hero, skill: Skill, artifact: Artifact, inputValues: DamageFormData, attackMultiplier: number, soulburn: boolean) => hero.getAttack(artifact, inputValues, attackMultiplier, skill, soulburn, HitType.normal) * 0.25,
    skills: {
      s1: new Skill({
        id: 's1',
        rate: () => 0.95,
  ...
  shadow_knight_pyllis: new Hero({
    ...
    heroSpecific: ['casterDefense', 'casterAttackedStack'],
    heroSpecificMaximums: {'casterAttackedStack': 3},
    barrier: (hero: Hero, skill: Skill, artifact: Artifact, inputValues: DamageFormData, _attackMultiplier: number, _soulburn: boolean) => inputValues.casterFinalDefense(artifact, Heroes.shadow_knight_pyllis.defenseIncrease(inputValues)) * 0.6,
    defenseIncrease: (inputValues: DamageFormData) => {
      return inputValues.casterAttackedStack * 0.1;
    },
    skills: {
      s1: new Skill({
        ...
        rate: () => 0.7,
        pow: () => 1,
        flat: (soulburn: boolean, inputValues: DamageFormData, artifact: Artifact) => inputValues.casterFinalDefense(artifact, Heroes.shadow_knight_pyllis.defenseIncrease(inputValues)) * 0.5,
        flatTip: () => ({ casterDefense: 50, per_stack: 10 }),
        enhance: [0.05, 0, 0.1, 0, 0.15],
        isSingle: () => true,
      }),
      s3: new Skill({
        ...
        rate: () => 1.3,
        pow: () => 0.95,
        flat: (soulburn: boolean, inputValues: DamageFormData, artifact: Artifact) => inputValues.casterFinalDefense(artifact, Heroes.shadow_knight_pyllis.defenseIncrease(inputValues)) * 0.7,
        flatTip: () => ({ casterDefense: 70, per_stack: 10 }),
        enhance: [0.05, 0.05, 0, 0.1, 0.15],
        isSingle: () => true,
      })
  ...
  shepherd_jena: new Hero({
    ...
    skills: {
      ...
      s3: new Skill({
        ...
        rate: () => 0.85,
        pow: () => 0.95,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => inputValues.skillTreeCompleted ? 1.05 : 1,
  ...
  shuna: new Hero({
    ...
    class: HeroClass.soul_weaver,
    heroSpecific: ['casterMaxHP'],
    barrier: (hero: Hero, skill: Skill, artifact: Artifact, inputValues: DamageFormData, _attackMultiplier: number, _soulburn: boolean) => inputValues.casterFinalMaxHP(artifact) * 0.18,
    barrierEnhance: 's2',
    baseAttack: 649,
    baseHP: 5254,
    baseDefense: 694,
  ...
  sealed_eye_surin: new Hero({
    ...
    skills: {
      ...
      s1_bis: new Skill({
        id: 's1_bis',
        name: 'sealedEyeSurinEradication',
        rate: () => 0.5,
        pow: () => 1.3,
        detonate: DoT.bleed,
        detonation: () => 1.3,
  ...
  setsuka: new Hero({
    ...
    barrier: (hero: Hero, skill: Skill, artifact: Artifact, inputValues: DamageFormData, _attackMultiplier: number, _soulburn: boolean) => inputValues.casterFinalMaxHP(artifact) * 0.35,
    skills: {
      s1: new Skill({
        id: 's1',
        hpScaling: true,
  ...
  sez: new Hero({
    ...
    baseHP: 6266,
    baseDefense: 473,
    heroSpecific: ['targetCurrentHPPercent', 'exclusiveEquipment1', 'exclusiveEquipment3', 'targetDefenseDownAftermath'],
    skills: {
      s1: new Skill({
        id: 's1',
        rate: () => 1,
      ...
      s1_bis: new Skill({
        ...
        rate: () => 0.6,
        pow: () => 1.3,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => 1 + (100 - inputValues.targetCurrentHPPercent) * 0.003,
      ...
      s3: new Skill({
        ...
        pow: () => 0.95,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => 1 + (100 - inputValues.targetCurrentHPPercent) * (soulburn ? 0.007 : 0.003),
  ...
  silver_blade_aramintha: new Hero({
    ...
    baseDefense: 683,
    dot: [DoT.burn],
    heroSpecific: ['casterEffectiveness', 'targetBurnDetonate'],
    flatAttackIncrease: (inputValues: DamageFormData, _artifact: Artifact) => inputValues.casterEffectiveness * 9,
    skills: {
      s1: new Skill({
        id: 's1',
        rate: () => 1,
      ...
      s1_bis: new Skill({
        id: 's1_bis',
        name: 'silverBladeAraminthaFlameRelease',
        rate: () => 0.5,
        pow: () => 1.3,
        enhanceFrom: 's1',
        isAOE: () => true,
  ...
  sol: new Hero({
    ...
    baseHP: 5542,
    baseDefense: 553,
    heroSpecific: ['targetHasBuff', 'targetMaxHP', 'targetDefenseDownAftermath'],
    skills: {
      s1: new Skill({
        id: 's1',
        rate: () => 1,
        pow: () => 1,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => inputValues.targetHasBuff ? 1 : 1.2,
  ...
  solitaria_of_the_snow: new Hero({
    ...
    skills: {
      ...
      s1_bis: new Skill({
        id: 's1_bis',
        name: 'solitariaOfTheSnowFwooooosh-Ha!',
        rate: () => 0.8,
        pow: () => 1.3,
        isAOE: () => true,
      }),
  ...
  sonia: new Hero({
    ...
    class: HeroClass.soul_weaver,
    heroSpecific: ['casterMaxHP'],
    barrier: (hero: Hero, skill: Skill, artifact: Artifact, inputValues: DamageFormData, _attackMultiplier: number, _soulburn: boolean) => inputValues.casterFinalMaxHP(artifact) * 0.08,
    baseAttack: 540,
    baseHP: 4900,
    baseDefense: 729,
    skills: {
  ...
  spirit_eye_celine: new Hero({
    ...
    skills: {
      s1: new Skill({
        ...
        pow: () => 0.9,
        soulburn: true,
        mult: (soulburn: boolean, _inputValues: DamageFormData, _artifact: Artifact) => 1 + (soulburn ? 0.5 : 0),
        enhance: [0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.1],
        isSingle: () => true,
      }),
      s1_bis: new Skill({
  ...
  stark: new Hero({
    ...
    class: HeroClass.warrior,
    heroSpecific: ['casterMaxHP', 'skill3Stack'],
    heroSpecificMaximums: {'skill3Stack': 3},
    baseAttack: 966,
    baseHP: 7323,
    baseDefense: 657,
    skills: {
      ...
      s3: new Skill({
        ...
        rate: (soulburn: boolean) => soulburn ? 0.9 : 0.7,
        pow: () => 1,
        flat: (soulburn: boolean, inputValues: DamageFormData, artifact: Artifact) => inputValues.casterFinalMaxHP(artifact) * (soulburn ? 0.16 : 0.12),
        flatTip: (soulburn: boolean) => ({ casterMaxHP: soulburn ? 16 : 12 }),
        mult: (soulburn: boolean, inputValues: DamageFormData) => 1 + inputValues.skill3Stack * 0.3,
        multTip: () => ({per_stack: 10}),
        isSingle: () => true,
        enhance: [0.05, 0.05, 0, 0.1, 0.1],
        penetrate: () => 0.5,
        onlyCrit: () => true,
  ...
  successor_taeyou: new Hero({
    ...
    skills: {
      ...
      s1_bis: new Skill({
        id: 's1_bis',
        name: 'successorTaeyouRoaringSpiritfall',
        rate: () => 1.85,
        pow: () => 1,
        enhanceFrom: 's1',
        onlyCrit: () => true,
  ...
  summer_disciple_alexa: new Hero({
    ...
    skills: {
      ...
      s1_bis: new Skill({
        id: 's1_bis',
        name: 'summerDiscipleAlexaLightningBolt',
        rate: () => 0.75,
        pow: () => 1,
        isSingle: () => true,
        isExtra: true,
      ...
      s2: new Skill({
        ...
        rate: () => 1,
        pow: () => 1,
        mult: (_soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => 1 + (inputValues.skillTreeCompleted ? 0.1 : 0),
        multTip: () => ({skill_tree: 10}),
        enhance: [0.05, 0, 0, 0.1, 0, 0.15],
        isSingle: () => true,
      }),
      s3: new Skill({
        ...
        rate: () => 1.5,
        pow: () => 0.9,
        mult: (_soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => 1 + inputValues.targetNumberOfDebuffs * 0.15,
        multTip: () => ({per_target_debuff: 15}),
  ...
  surin: new Hero({
    ...
    skills: {
      ...
      s3: new Skill({
        ...
        rate: () => 1.8,
        pow: () => 0.8,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => inputValues.targetNumberOfBleeds > 0 ? 1.4 + (Math.min(inputValues.targetNumberOfBleeds, 5) - 1) * 0.15 : 1,
  ...
  sven: new Hero({
    ...
    skills: {
      ...
      s1_bis: new Skill({
        id: 's1_bis',
        name: 'svenRepellingBlow',
        rate: () => 0.7,
        pow: () => 1,
        enhanceFrom: 's1',
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => 1 + (100 - inputValues.casterCurrentHPPercent) * 0.003,
      ...
      s3: new Skill({
        ...
        rate: (soulburn: boolean) => soulburn ? 1 : 0.8,
        pow: () => 0.8,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => 1 + (100 - inputValues.casterCurrentHPPercent) * 0.005 + (100 - inputValues.targetCurrentHPPercent) * 0.0015,
    ...
    swift_flagbearer_sigret: new Hero({
    element: HeroElement.fire,
    class: HeroClass.thief,
    baseAttack: 1057,
    baseHP: 5542,
  ...
  tactical_archetype_coli: new Hero({
    element: HeroElement.ice,
    class: HeroClass.thief,
    baseAttack: 1057,
    baseHP: 5542,
    baseDefense: 532,
    heroSpecific: ['targetBombDetonate', 'casterOverload', 'casterEnergyDepletion'],
    dot: [DoT.bomb, DoT.bleed],
    skills: {
      s1: new Skill({
        id: 's1',
        rate: () => 1,
        pow: () => 1,
        enhance: [0.05, 0.0, 0.05, 0.05, 0.0, 0.15],
        detonate: [DoT.bleed],
        detonation: () => 1.3,
        isSingle: () => true,
      }),
      s2: new Skill({
        id: 's2',
        name: 'tactical_archetype_coli_flank_strike',
        rate: () => 1,
        pow: () => 1,
        isExtra: true,
        isSingle: () => true,
  ...
  talaz: new Hero({
    ...
    skills: {
      ...
      s3: new Skill({
        ...
        rate: (soulburn: boolean) => soulburn ? 1.8 : 1.5,
        pow: () => 0.9,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => 1 + (inputValues.targetProvoked ? 0.5 : 0),
  ...
  tempest_surin: new Hero({
    ...
    skills: {
      s1: new Skill({
        ...
        rate: () => 1,
        pow: () => 1,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => 1 + (100 - inputValues.casterCurrentHPPercent) * 0.0015,
  ...
  tieria: new Hero({
    ...
    skills: {
      ...
      s3: new Skill({
        ...
        pow: () => 0.9,
        flat: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => inputValues.targetFinalMaxHP() * (soulburn ? 0.06 : 0.04),
    ...
    skills: {
      ...
      s3: new Skill({
        ...
        penetrate: (soulburn: boolean, inputValues: DamageFormData, artifact: Artifact, casterAttack: number, casterSpeed: number) => {
          ...
          if (targetSpeed < casterSpeed) {
            penDiff = (casterSpeed - targetSpeed) * 0.0025;
          }

          return Math.min(Math.max(0, penDiff + penetration), 1);
        },
        penetrateTip: () => ({caster_target_spd_diff: 0.0025}),
        enhance: [0.05, 0.05, 0, 0.1, 0.1],
        isSingle: () => true,
      })
    }
  ...
  top_model_luluca_old: new Hero({
    ...
    skills: {
      ...
      s3: new Skill({
        ...
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => 1 + inputValues.casterFinalSpeed() * 0.0015,
        multTip: () => ({ casterSpeed: 0.15 }),
        penetrate: (soulburn: boolean, inputValues: DamageFormData) => inputValues.casterFinalSpeed() >= inputValues.targetFinalSpeed() * 2 ? 0.5 : 0,
        enhance: [0.05, 0.05, 0, 0.1, 0.1],
        isSingle: () => true,
      })
    }
  ...
  tori: new Hero({
    ...
    skills: {
      s1: new Skill({
        id: 's1',
        rate: (soulburn: boolean) => soulburn ? 2.3 : 1.2,
        pow: () => 0.9,
        enhance: [0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.1],
        soulburn: true,
        isSingle: () => true,
  ...
  twisted_eidolon_kayron: new Hero({ //TODO: translate when available
    ...
    baseHP: 6266,
    baseDefense: 473,
    barrier: (hero: Hero, skill: Skill, artifact: Artifact, inputValues: DamageFormData, _attackMultiplier: number, _soulburn: boolean) => inputValues.casterFinalMaxHP(artifact) * 0.12,
    ...
    skills: {
      ...
      s3: new Skill({
        ...
        rate: () => 0.7,
        pow: () => 1,
        fixed: (hitType: HitType, inputValues: DamageFormData) => 5000 + Math.min(100 * inputValues.casterFightingSpirit, 10000),
  ...
  unbound_knight_arowell: new Hero({
    ...
    resistanceIncrease: (artifact: Artifact, inputValues: DamageFormData) => inputValues.casterFinalMaxHP(artifact) * 0.003,
    barrier: (hero: Hero, skill: Skill, artifact: Artifact, inputValues: DamageFormData, _attackMultiplier: number, _soulburn: boolean) => inputValues.casterFinalMaxHP(artifact) * 0.15,
    barrier2: (hero: Hero, skill: Skill, artifact: Artifact, inputValues: DamageFormData, _attackMultiplier: number) => inputValues.casterFinalMaxHP(artifact) * 0.2,
    skills: {
      s1: new Skill({
        id: 's1',
        hpScaling: true,
  ...
  verdant_adin: new Hero({
    ...
    skills: {
      s1: new Skill({
        ...
        rate: () => 1,
        pow: () => 0.95,
        mult: (_soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => inputValues.skillTreeCompleted ? 1.1 : 1,
        multTip: (inputValues: DamageFormData) => (inputValues.skillTreeCompleted ? { skill_tree: 10 } : null),
        enhance: [0.05, 0.05, 0.05, 0.1, 0.1],
        isSingle: () => true,
      }),
      s2: new Skill({
        ...
        rate: () => 0.8,
        pow: () => 1,
        mult: (_soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => {
          switch (inputValues.numberOfTargets) {
          case 3: return 1.2;
          case 2: return 1.4;
          case 1: return 1.6;
  ...
  vigilante_leader_glenn: new Hero({
    ...
    skills: {
      s1: new Skill({
        ...
        rate: () => 1,
        pow: () => 1,
        mult: (_soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => inputValues.skillTreeCompleted ? (1.1 + (inputValues.elementalAdvantage ? 0.25 : 0)) : 1,
      ...
      s2: new Skill({
        ...
        soulburn: true,
        rate: (soulburn: boolean) => soulburn ? 2.2 : 1.5,
        mult: (_soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => inputValues.skillTreeCompleted && inputValues.elementalAdvantage ? 1.25 : 1,
  ...
  vildred: new Hero({
    ...
    skills: {
      ...
      s2: new Skill({
        ...
        rate: () => 0.5,
        pow: () => 1,
        mult: (_soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => 1 + inputValues.casterFinalSpeed() * 0.001125,
        multTip: () => ({ casterSpeed: 0.1125 }),
        enhance: [0.05, 0.05, 0.05, 0.05, 0.1],
        isAOE: () => true,
      }),
  ...
  violet: new Hero({
    ...
    skills: {
      ...
      s3: new Skill({
        ...
        rate: () => 1.5,
        pow: () => 0.9,
        mult: (_soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => 1 + inputValues.casterFocus * 0.15,
  ...
  yufine: new Hero({
    ...
    baseHP: 5784,
    baseDefense: 553,
    heroSpecific: ['exclusiveEquipment2', 'targetHasDebuff'],
    skills: {
      s1: new Skill({
        id: 's1',
        rate: () => 1,
  ...
  yulha: new Hero({
    ...
    skills: {
      ...
      s3: new Skill({
        ...
        rate: () => 0.5,
        pow: () => 1,
        flat: (soulburn: boolean, inputValues: DamageFormData, artifact: Artifact) => (soulburn ? 0.42 : 0.31) * Math.max(inputValues.casterFinalMaxHP(artifact) - inputValues.casterCurrentHP, 0),
        flatTip: (soulburn: boolean) => ({caster_lost_hp: soulburn ? 42 : 31}),
        penetrate: () => 1.0,
        enhance: [0.05, 0.05, 0, 0.1, 0.1],
        noCrit: true,
        ignoreDamageTransfer: () => true,
  ...
  zahhak: new Hero({
    ...
    baseHP: 5542,
    baseDefense: 553,
    heroSpecific: ['targetHasBuff', 'exclusiveEquipment1'],
    skills: {
      s1: new Skill({
        id: 's1',
        soulburn: true,
        rate: (soulburn: boolean) => soulburn ? 1.8 : 1.1,
        pow: () => 1,
        mult: (soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => inputValues.targetHasBuff ? 1.3 : 1,
  ...
  zealot_carmainerose: new Hero({
    ...
    skills: {
      s1: new Skill({
        ...
        rate: () => 1,
        pow: () => 1,
        mult: (_soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => inputValues.skillTreeCompleted && !inputValues.targetHasBuff ? 1.1 : 1,
  ...
  zeno: new Hero({
    ...
    baseHP: 5299,
    baseDefense: 673,
    heroSpecific: ['casterDefense', 'nonAttackSkillStack'],
    ...
    skills: {
      ...
      s3: new Skill({
        ...
        rate: () => 1,
        pow: () => 1,
        flat: (soulburn: boolean, inputValues: DamageFormData, artifact: Artifact) => inputValues.casterFinalDefense(artifact) * 1.6,
        flatTip: () => ({ casterMaxHP: 12 }),
        enhance: [0.05, 0.05, 0.05, 0.05, 0.1],
        isAOE: () => true,
      })
    ...
    skills: {
      ...
      s3: new Skill({
        ...
        mult: (molagoras: Record<string, number>, inputValues: DamageFormData) => {
          let extra = 0;
          for (let i = 0; i < inputValues.molagoras2; i++) {
            extra += Heroes.zeno_old.skills.s2.enhance[i];
          }
  ...
  zerato: new Hero({
    ...
    skills: {
      ...
      s2: new Skill({
        ...
        rate: (soulburn: boolean) => soulburn ? 2 : 1.5,
        pow: () => 0.95,
        mult: (_soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => inputValues.targetHasDebuff ? 1.3 : 1,
  ...
  zio: new Hero({
    ...
    skills: {
      ...
      s3: new Skill({
        ...
        rate: () => 0.2,
        pow: () => 1,
        flat: (_soulburn: boolean, inputValues: DamageFormData, _artifact: Artifact) => inputValues.targetCurrentHP * 0.1875,
