...
const ENABLE_SYNERGY_BANS = false;
const ENABLE_COUNTER_THREATS = false;
const ENABLE_GEAR_RATING = false;
const ENABLE_LEADERBOARD = false;
const ENABLE_BUILDS_TABLE = false;
...
export const HeroDetailsView: React.FC<HeroDetailsViewProps> = ({
    ...
    return (
        <div 
            ...
            style={isHidingForOCR ? { opacity: 0, pointerEvents: 'none', transition: 'opacity 0.25s ease' } : { transition: 'opacity 0.25s ease' }}
        >
